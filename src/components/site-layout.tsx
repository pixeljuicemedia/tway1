            ...
            {nav.slice(1).map((n) =>
              n.to === "/shop" ? (
                ...
                <Link
                  key={n.to}
                  to={n.to}
                  className="font-display text-[16px] font-bold tracking-wide text-white/90 hover:text-white transition-colors"
...
function ShopMenu() {
  ...
  return (
    ...
    >
      <Link
        to="/shop"
        className="font-display text-[16px] font-bold tracking-wide text-white/90 hover:text-white transition-colors inline-flex items-center gap-1.5"
        activeProps={{ className: "text-white" }}
      >
        Shop
