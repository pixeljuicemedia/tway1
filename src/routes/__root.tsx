...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Tway Motorsports" },
      ...
      { name: "twitter:title", content: "Tway Motorsports — Race-Proven Performance. Built by Racers." },
      { name: "twitter:description", content: "Family-owned Corvette race shop. 25+ years of engineering, fabrication, dyno tuning and trackside support. Real racing experience — no theory." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/f3943eff-2b6d-4e2f-b821-ca0babc82722" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/f3943eff-2b6d-4e2f-b821-ca0babc82722" },
    ],
    links: [
