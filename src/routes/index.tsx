...
import burnout4 from "@/assets/c8hero4.jpg.asset.json";
const burnoutFrames = [burnout1, burnout2, burnout3, burnout4];
const CROSSFADE_CYCLE_S = 9;
...
const recentBuilds = [
  ...
  { title: "Silver #55 C5 Z06 · Track Build",   tag: "Race Prep",      img: buildC5Silver.url },
];
